...
void Skobina::Object_Oriented::Multi_Method(Language* Other, ofstream& FileOutput)
{
	Other->Multi_Method_First_Obj_OOP(FileOutput);
}


void Skobina::Object_Oriented::Multi_Method_First_Obj_Procedural(ofstream& FileOutput)
{
	FileOutput << "Procedural and OOP." << endl;
}


void Skobina::Object_Oriented::Multi_Method_First_Obj_OOP(ofstream& FileOutput)
{
	FileOutput << "OOP and OOP." << endl;
}


void Skobina::Object_Oriented::Multi_Method_First_Obj_Functional(ofstream& FileOutput)
{
